...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('meanbaseApp').directive('mbPanel', ['api', api => ({
	  ...
	  link: (() => {
	    var _ref = _asyncToGenerator(function* (scope, element, attrs) {
	      ...
	      let removeAutoSaveData = (() => {
	        var _ref3 = _asyncToGenerator(function* () {
	          try {
	            yield api.staging.delete({ belongsTo: scope.listItem.label, key: scope.listItem.key });
	        ...
	        return function removeAutoSaveData() {
	          return _ref3.apply(this, arguments);
	        };
	      })();
	
	      let fetchAutoSaveData = (() => {
	        var _ref4 = _asyncToGenerator(function* () {
	          try {
	            let data = yield api.staging.find({ belongsTo: scope.listItem.label, key: scope.listItem.key });
	            data = data[0];
	            if (data) {
	        ...
	        return function fetchAutoSaveData() {
	      ...
	      let autoSaveEdits = (() => {
	        var _ref5 = _asyncToGenerator(function* (event) {
	          try {
	            ...
	            if (alreadyHasAutoSaveData) {
	              response = yield api.staging.update({ belongsTo: scope.listItem.label, key: scope.listItem.key }, { data: scope.data });
	            } else {
	              response = yield api.staging.create({ belongsTo: scope.listItem.label, key: scope.listItem.key, data: scope.data, enabled: true, permission: 'editContent' });
	              alreadyHasAutoSaveData = true;
	            }
	            scope.data = response.value;
	          } catch (err) {
	        ...
	        return function autoSaveEdits(_x5) {
